...
namespace NppPluginNET
{
    ...
    /// <summary>
    /// Zoznam flagov pre tabs menu - pod hlavným menu
    /// </summary>
    [Flags]
    ...
    public class Sci_TextRange : IDisposable
    {
        ...
        public void Dispose()
        {
            if (!_disposed)
            {
                // TODO: Marshal.FreeHGlobal(_sciTextRange.lpstrText); očividne nefunguje...
                // odstránené, ale vzniká memory leak!!!
